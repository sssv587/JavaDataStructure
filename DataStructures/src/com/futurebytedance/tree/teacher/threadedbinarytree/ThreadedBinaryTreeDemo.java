package com.futurebytedance.tree.teacher.threadedbinarytree;
...
public class ThreadedBinaryTreeDemo {
    public static void main(String[] args) {
        ...
        HeroNode node2 = new HeroNode(8, "smith");
        HeroNode node3 = new HeroNode(10, "mary");
        HeroNode node4 = new HeroNode(6, "king");
        HeroNode node5 = new HeroNode(14, "dim");

        //二叉树，后续我们要递归创建，现在简单使用手动创建
        root.setLeft(node1);
        root.setRight(node4);
        node1.setLeft(node2);
...
class HeroNode {
    ...
    //2.如果rightType=0表示指向是右子树，如果是1则表示指向的是后续节点
